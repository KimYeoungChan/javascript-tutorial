...
const groundName = "아이브";
console.log(groundName + " 안유진");
console.log(`${groundName} 안유진`);
...
console.log(dictinary["red"]);
console.log(dictinary["orange"]);
console.log(dictinary["yellow"]);
